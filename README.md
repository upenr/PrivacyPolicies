...
<p>The app does not use third party services that may collect information used to identify you. The apps may need some of the aforementioned permissions to provide the service and some storage space to store the data before processing it. Nothing else is collected or shared over the network. 

<p><strong>Log Data</strong></p>
<p> We want to inform you that whenever you use our Service, in case of an error in the app we do NOT collect
...
<p>Wemay update our Privacy Policy from time to time. Thus, you are advised to review this page
